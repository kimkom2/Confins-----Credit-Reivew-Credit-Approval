...
for (int baris = 1; baris <= Datahohendy.getRowNumbers(); baris++)
{
	if (Datahohendy.getValue('Use', baris) == 'Yes' && Datahohendy.getValue('Bisnis Unit', baris) == 'Non Motor')
	{
		...
		WebUI.setText(findTestObject('Object Repository/Menu/Credit Approval/AppNo'), Datahohendy.getValue('Application', baris))
		...
		WebUI.click(findTestObject('Object Repository/Menu/Credit Approval/Action/Action '+ Datahohendy.getValue('Action Approval', baris)))
		
		WebUI.delay(4)
		
		WebUI.setText(findTestObject('Object Repository/Menu/Credit Approval/txtNotes'), Datahohendy.getValue('Notes', baris))
		...
		if (Datahohendy.getValue('Use', baris) == 'Yes' && Datahohendy.getValue('Bisnis Unit', baris) == 'Non Motor' && Datahohendy.getValue('Action Approval', baris) == 'Return')
		{
			
			WebUI.setText(findTestObject('Object Repository/Menu/Credit Approval/ReturnNotes'), Datahohendy.getValue('Return Notes', baris))
			
			WebUI.delay(2)
			
			WebUI.click(findTestObject('Object Repository/Menu/Credit Approval/Return Action/Return '+ Datahohendy.getValue('Return Action', baris)))
